...
public record OrderCreatedEvent(String orderNumber, List<Item> items, Customer customer) {
     ...
     */
    public record Item(String productCode, String productName, BigDecimal productPrice, int quantity) {}

    /**
     * El Customer va embebido para que los consumidores externos
     * no necesiten consultar la aplicación para obtener estos datos.
     */
    public record Customer(String name, String email, String phone, String deliveryAddress) {}
}
