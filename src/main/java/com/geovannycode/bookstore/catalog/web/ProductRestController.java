...
public class ProductRestController {
    ...
    List<Product> getTopRated(@RequestParam(defaultValue = "4.0") double minRating) {
    ...
    @PutMapping("/{code}")
    Product update(@PathVariable String code, @Valid @RequestBody UpdateProductCommand command) {
